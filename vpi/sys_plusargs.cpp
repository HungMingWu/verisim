...
export {
	 ...
	 */
	PLI_INT32 sys_test_plusargs_calltf(ICARUS_VPI_CONST PLI_BYTE8* name);

	PLI_INT32 sys_value_plusargs_calltf(ICARUS_VPI_CONST PLI_BYTE8* name);

	PLI_INT32 sys_value_plusargs_compiletf(ICARUS_VPI_CONST PLI_BYTE8* name);
}
